    ...
    case 'running':
      return (
        <svg aria-hidden="true" viewBox="0 0 64 64" fill="none">
          ...
          <path
            fill="#333"
            d="M56.5 41.1c-1.4-1.2-5.4-2-6.5-3.1c-4.2-4.6-13-12.7-20.5-26.4c-2.7-5.1-15.2 3.8-15.2 3.8l21.8 34.7c.2 0 25.6-4.7 20.4-9"
          />
          <path
            fill="#5b636b"
    ...
    case 'walking':
      return (
        <svg aria-hidden="true" viewBox="0 0 64 64" fill="none">
          ...
          <path
            fill="#28b473"
            d="M36.781 35.12c0 3.336-2.282 6.04-5.099 6.04c-2.813 0-5.098-2.704-5.098-6.04v-12.4c0-3.336 2.285-6.04 5.098-6.04c2.816 0 5.099 2.704 5.099 6.04z"
          />
          <path
            fill="#249561"
          ...
          <path
            fill="#193e6b"
            d="M25.372 57.824c-1.75 3.533-4.443 5.765-6.01 4.988c-1.565-.78-1.414-4.273.337-7.805l6.522-13.144c1.752-3.529 4.446-5.769 6.01-4.987c1.565.775 1.417 4.271-.335 7.803z"
          />
          <path
            fill="#d1d2d2"
          ...
          <path
            fill="#1c447d"
            d="M45.973 53.38c2.233 2.995 2.836 6.327 1.336 7.439c-1.496 1.123-4.521-.397-6.752-3.395l-8.313-11.135c-2.238-2.99-2.835-6.327-1.34-7.444c1.499-1.112 4.522.406 6.758 3.397z"
          />
          <path
            fill="#d1d2d2"
          ...
          <path
            fill="#1c447d"
            d="M26.142 42.11h11.233c.092 0-.503-6.299-.503-7.153c0-.058-4.796-.106-7.109-.106c-1.471 0-3.214-.005-3.216 0c0 0-.5 7.259-.405 7.259"
          />
          <path
            fill="#193e6b"
    ...
    case 'cycling':
      return (
        <svg aria-hidden="true" viewBox="0 0 128 128" fill="none">
          <path
            fill="#F0A007"
            d="m61.5 58.26l-6.04-2.15s-4.95 2.99-4.5 6.82s3.96 9.01 5.11 10.8s6.84 10.55 6.84 10.55l5.18-2.11l.77-14.06l-7.35-9.84z"
          />
          <path
            fill="#858585"
            d="m66.93 81.35l-4.34 2.71s.9 1.52 1.21 2.03s1.13 2.14 1.13 2.14l1.17 2.25l-.83 1.73l.06 2.24l2.94 2.62l2.81-5.88l-4.16-9.83z"
          />
          <path
            fill="#00BDA3"
            d="m67.32 87.99l-2.42.22s.29 1.27.37 2.21s0 2.13 0 2.13l3.91-.28l-1.85-4.28z"
          />
          <path
            fill="#F09E00"
            d="M27.07 56.05s5.74-3.03 7.96-3.93c3.14-1.28 5.31-1.47 5.31-1.47l1.08 9.63l-14.34-4.22z"
          />
          <path
            fill="#9A9A9A"
            d="M106.5 102.59c.96-2.53.9-6.2-2.56-7.69s-6.56.38-7.55 2.19c-.98 1.81-1.5 6.3 2.03 8.14c3.45 1.8 7.02.15 8.08-2.65z"
          />
          <path
            fill="#606265"
            d="M100.54 123.18c-12.82 0-23.26-10.42-23.26-23.22s10.43-23.22 23.26-23.22s23.26 10.42 23.26 23.22s-10.43 23.22-23.26 23.22m0-42.13c-10.44 0-18.94 8.48-18.94 18.9s8.5 18.91 18.94 18.91s18.94-8.48 18.94-18.91s-8.5-18.9-18.94-18.9m-72.99 43.12c-12.87 0-23.34-10.49-23.34-23.38s10.47-23.38 23.34-23.38s23.34 10.49 23.34 23.38s-10.47 23.38-23.34 23.38m0-42.43c-10.49 0-19.02 8.55-19.02 19.05s8.53 19.05 19.02 19.05s19.02-8.55 19.02-19.05s-8.53-19.05-19.02-19.05"
          />
          <path
            fill="#9A9A9A"
            d="M25.34 104.56c2.36 1.42 5.29.57 6.52-1.79s.72-4.9-1.72-6.33s-5.03-.37-6.22 1.7c-1.07 1.87-1.08 4.92 1.42 6.42"
          />
          <path
            fill="#B0B0B0"
...
const ActivityList: React.FC = () => {
  ...
  const RunningSvg = useMemo(
    () => MonthOfLifeSvg('running', language),
    [language]
  );
  const WalkingSvg = useMemo(
    () => MonthOfLifeSvg('walking', language),
    [language]
  );
  const HikingSvg = useMemo(
    () => MonthOfLifeSvg('hiking', language),
    [language]
  );
  const CyclingSvg = useMemo(
    () => MonthOfLifeSvg('cycling', language),
    [language]
  );
  const SwimmingSvg = useMemo(
    () => MonthOfLifeSvg('swimming', language),
    [language]
  );
  const SkiingSvg = useMemo(
    () => MonthOfLifeSvg('skiing', language),
    [language]
  );
